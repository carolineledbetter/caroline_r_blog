...
`apply` family - namily unified syntex and the ability to specify the output 
...
dat <- tibble(!!!c(id = list(1:10), 
  ...
  lgl_ = replicate(3, sample(c(T, F), 10, replace = T), simplify = F), 
  chr_ = replicate(3, sample(c("A", "B", "C"), 10, replace = T), simplify = F)
